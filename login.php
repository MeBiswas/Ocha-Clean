                    ...
                    <div class="wrap-form">
                        <form action="#" class="log-reg-form" novalidate="novalidate">
                            ...
                            <div class="input-wrap m-b-23">
                                <span class="input-lbl">Email</span>
                                <input class="cstm-input" type="text" name="username" placeholder="Type your email">
                            ...
                            <div class="log-frgt-pswd p-t-8"><a href="forgotPassword.php">Forgot password?</a></div>
                            
                            <div class="log-reg-btn-wrap m-t-51">
                                <button class="btn theme-btn" onClick="toCleanerProfile()">Login</button>
                            </div>
                            ...
                            <div class="alrd-hv-acc m-t-30">
                                <a href="userRegistration.php">Don't have an account Register</a>
                            </div>
                        </form>
                    </div>
                </div>
