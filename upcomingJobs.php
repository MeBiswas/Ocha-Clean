                    ...
                    <div class="col-12">
                        <div class="pst-upcmg-jb-wrap">
                            <div class="row">
                                <div class="col-12">
                                    <div class="sec-hed">
                                        <h2 class="sec-title">Upcoming Jobs</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="clnr-jobs-wrap">
                                        <div class="single-job-wrap">
                                            <div class="single-job-btn-wrap">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button class="btn job-action-btn">Accepted</button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="single-job-wrap">
                                            <div class="single-job-btn-wrap">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button class="btn job-action-btn" data-toggle="modal" data-target="#acceptBooking">Accept</button>
                                                        <button class="btn job-action-btn" data-toggle="modal" data-target="#rejectBooking">Reject</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="single-job-body-wrap">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="action-icn-wrap inactive">
                                                            <a href="javascript:;" class="action-icn"><i class="fas fa-street-view"></i></a>
                                                            <a href="javascript:;" class="action-icn"><i class="fas fa-envelope"></i></a>
                                                            <a href="javascript:;" class="action-icn"><i class="fab fa-whatsapp"></i></a>
                                                            <a href="javascript:;" class="action-icn"><i class="fas fa-comment"></i></a>
